  ...
  return (
    <section id="services" aria-labelledby="services-title" className="border-b-2 border-line bg-surface">
      <div className="mx-auto max-w-6xl px-3 py-10">
        <SectionHeading id="services-title" number="01" title={t.services.heading} sub={t.services.sub} />
            ...
            return (
              <li key={id} className="flex flex-col border-2 border-line bg-page">
                ...
                <div className="flex grow flex-col justify-between p-4">
                  ...
                  <a
                    href="#/contact"
                    className="mt-3 inline-block border-2 border-brand bg-brand px-4 py-2.5 text-center text-base font-bold text-white no-underline hover:bg-branddark"
                  >
                    {t.services.open}
                  </a>
                </div>
